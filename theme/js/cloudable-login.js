			...
			submitHandler: function(ev)
			{
				...
				*/
				...
				setTimeout(function()
				{
					...
					$.ajax({
						url: WEB_ROOT + '/ajax/account_login.ajax.php',
						method: 'POST',
						dataType: 'json',
						data: {
						...
						error: function(jqXHR, textStatus)
						{
							...
							flowLogin.resetProgressBar(false);
						},
		...
		flowForgotPassword.$container.validate({
			...
			submitHandler: function(ev)
			{
				...
				setTimeout(function()
				{
					...
					// Send data to the server
					$.ajax({
						url: WEB_ROOT + '/ajax/account_forgot_password.ajax.php',
						method: 'POST',
						dataType: 'json',
						data: {
						...
						error: function()
						{
							...
							$(".login-page").removeClass('logging-in');
							flowForgotPassword.resetProgressBar(false);
						},
						success: function(response)
						{
							// Login status [success|invalid]
		...
		flowForgotPasswordReset.$container.validate({
			...
			submitHandler: function(ev)
			{
				...
				setTimeout(function()
				{
					...
					// Send data to the server
					$.ajax({
						url: WEB_ROOT + '/ajax/account_forgot_password_reset.ajax.php',
						method: 'POST',
						dataType: 'json',
						data: {
							password: $("input#password").val(),
                            passwordConfirm: $("input#passwordConfirm").val(),
                            u: $("input#u").val(),
							i: $("input#i").val(),
                            h: $("input#h").val()
						},
						error: function()
						{
							...
							$(".login-page").removeClass('logging-in');
							flowForgotPasswordReset.resetProgressBar(false);
						},
						success: function(response)
						{
							// Login status [success|invalid]
